...
export default function PortfolioPage() {
  ...
  useEffect(() => {
    const fetchPortfolio = async () => {
      ...
      try {
        ...
        const holdings = (await Promise.all(holdingsPromises)).filter(
          Boolean
        ) as PortfolioHolding[];
        ...
        if (wishlistRes.ok) {
          ...
          wishlistItems = (await Promise.all(wishlistPromises)).filter(
            Boolean
          ) as WishlistItem[];
        }
  ...
  const totalReturnPercent = portfolioData?.totalInvested
    ...
    : 0;
  const tokensOwned =
    portfolioData?.holdings.reduce((sum, h) => sum + h.quantity, 0) || 0;
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-gray-900 pb-24">
        ...
        {portfolioData?.holdings && portfolioData.holdings.length > 0 ? (
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <PriceChange
                            value={holding.dailyPriceChange}
                            size="sm"
                          />
                        </div>
                      </div>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-6 text-center">
            <p className="text-gray-500">
              No stamps yet. Back a dish to get started!
            </p>
            <Link
              href="/explore"
      ...
      <div className="px-4">
        ...
        {portfolioData?.createdDishes &&
        portfolioData.createdDishes.length > 0 ? (
          <div className="space-y-3">
                      ...
                      {dish.referredTo.length > 0 && (
                        <div className="mt-2 pt-2 border-t border-gray-100">
                          <p className="text-xs text-green-600 flex items-center gap-1">
                            ...
                            Earned 2.5% from {dish.referredTo.length} referral
                            {dish.referredTo.length > 1 ? "s" : ""}:
        ...
        {wishlist.length > 0 ? (
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-6 text-center">
            ...
            <p className="text-xs text-gray-400 mt-1">
              Heart dishes from other users&apos; profiles to add them here!
            </p>
          </div>
        )}
      </div>
