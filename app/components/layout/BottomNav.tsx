...
const NavItem = ({ 
  ...
  >
    ...
    <div 
      className={`absolute inset-0.5 rounded-2xl bg-gradient-to-br from-[var(--primary)]/25 to-[var(--primary-dark)]/15 transition-all duration-300 ${
    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50 safe-bottom pointer-events-none">
      <div className="max-w-lg mx-auto px-4 pb-3">
        ...
        <div className="pointer-events-auto relative pt-6">
          ...
          <div className="relative bg-white/80 backdrop-blur-xl border border-white/60 rounded-[24px] shadow-[0_8px_32px_rgba(155,135,197,0.18),0_4px_16px_rgba(0,0,0,0.06)]">
